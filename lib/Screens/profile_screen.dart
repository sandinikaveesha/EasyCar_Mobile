      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextbox(
                hintText: "Confirm Password", controller: _confirmPassword),
            const SizedBox(
              height: 30,
            ),
          ],
